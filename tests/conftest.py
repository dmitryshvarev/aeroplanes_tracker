...
def mock_nominatim_response():
    ...
    return [
        {
            'place_id': 123,
            'boundingbox': ['35.0', '70.0', '-10.0', '40.0'],
            'display_name': 'Russia'
        }
    ]
...
def mock_opensky_response():
    ...
    return {
        'time': 1234567890,
        'states': [
            ['abc123', 'AFL101  ', 'Russia', 1234567890, 1234567890,
             37.5, 55.5, 10500.0, False, 250.5, 120.0, 0.0, None, 11000.0, None, False, 0],
            ['def456', 'BAW202', 'United Kingdom', 1234567890, 1234567890,
             -0.1, 51.5, 9500.0, False, 240.0, 110.0, 0.0, None, 10000.0, None, False, 0],
        ]
    }
